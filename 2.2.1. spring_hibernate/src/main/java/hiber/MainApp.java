...
public class MainApp {
    public static void main(String[] args) throws SQLException {
        ...
        Car car2 = new Car("Subaru", 2);
        Car car3 = new Car("Dodge", 3);

        User user1 = new User("Vasya", "Ivanov", "sobaka@sobaka.ru");
        User user2 = new User("Ivan", "Vasyev", "samsobaka@sobaka.ru");
        User user3 = new User("Sobaka", "Ti", "ivanov@sobaka.ru");
